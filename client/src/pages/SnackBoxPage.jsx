...
const SnackBoxPage = () => {
  ...
  const fetchProducts = async () => {
    try {
      ...
      const { data } = await api.get('/menus/products?category=SnackBox');
      if (data.success) {
  ...
  return (
    <div className="min-h-screen bg-white font-sans relative overflow-hidden">
      ...
      <section className="relative h-[300px] md:h-[400px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4">
          <h1 className="text-3xl md:text-6xl font-black mb-4 tracking-tight font-heading uppercase">
            <span className="text-[#1a202c] drop-shadow-[0_0_15px_rgba(255,255,255,1)]">MSCATERERS</span><span className="text-[#BE2E3E] drop-shadow-[0_0_10px_rgba(255,255,255,0.5)]">SnackBox</span>
          </h1>
                ...
                <div className="absolute top-0 inset-x-0 h-16 bg-gradient-to-b from-black/60 to-transparent p-4 flex items-start justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <div className="text-white">
                      <p className="text-sm font-medium leading-tight">Snack Box - Quick Bites Delivery</p>
      ...
      <section className="py-12 px-4 bg-[#FDFBFB]">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-12">Why Choose <span className="text-[#B70C10]">Snack Box?</span></h2>
