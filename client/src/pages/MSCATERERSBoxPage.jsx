    ...
    <div className="min-h-screen bg-white font-sans relative overflow-hidden">
      ...
      <section className="relative h-[300px] md:h-[400px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4">
          <h1 className="text-3xl md:text-5xl font-black mb-4 tracking-tight drop-shadow-xl font-heading uppercase">
            <span className="text-[#FFD700]">MSCATERERS Box</span> Services
          </h1>
          <p className="text-base md:text-lg mb-8 max-w-2xl mx-auto font-medium drop-shadow-lg">
